#!/usr/bin/env python3
"""
OCR Benchmark: GOT-OCR2 (580M) via transformers.

Run from ocr_bench_venv:
    /home/budnik_an/Obligations/ocr_bench_venv/bin/python poc/bench_got_ocr2.py
"""
...
OUTPUT_FILE = PROJECT_ROOT / "poc" / "benchmark_results" / "got_ocr2.json"
DPI = 200
