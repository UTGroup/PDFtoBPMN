#!/usr/bin/env python3
"""
OCR Benchmark: DeepSeek-OCR v2.

Run from DeepSeek-OCR/venv:
    /home/budnik_an/Obligations/DeepSeek-OCR/venv/bin/python poc/bench_deepseek_v2.py
"""
...
OUTPUT_FILE = PROJECT_ROOT / "poc" / "benchmark_results" / "deepseek_v2.json"
...
def main():
    print("=" * 60)
    print("Benchmark: DeepSeek-OCR v2")
    print("=" * 60)
