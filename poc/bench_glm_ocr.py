#!/usr/bin/env python3
"""
OCR Benchmark: GLM-OCR (0.9B) via transformers.

Run from ocr_bench_venv:
    /home/budnik_an/Obligations/ocr_bench_venv/bin/python poc/bench_glm_ocr.py
"""
...
OUTPUT_FILE = PROJECT_ROOT / "poc" / "benchmark_results" / "glm_ocr.json"
DPI = 200
